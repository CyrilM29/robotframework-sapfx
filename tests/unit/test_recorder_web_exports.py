"""Recorder web : exports multi-formats, replay in-page, import round-trip, garde des artefacts generes. Doublures dans _recorder_web_features_fixtures."""
...
def test_listener_panel_carries_the_aicabra_icon_and_drag_affordance():
    ...
    from SapFioriLibrary._ui5_js import _AICABRA_ICON
